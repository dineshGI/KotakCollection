...
import com.kotakcollection.Module.DisputeMgnt;
import com.kotakcollection.R;


public class DisputeMgntTab extends Fragment {
    ...
    public static DisputeMgntTab newInstance(String param1, String param2) {
        DisputeMgntTab fragment = new DisputeMgntTab();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTabHost.addTab(mTabHost.newTabSpec("New").setIndicator("New"),
                DisputeMgnt.class, arg1);

        Bundle arg2 = new Bundle();
        arg2.putString("Title", "Completed");
        mTabHost.addTab(mTabHost.newTabSpec("Resolved").setIndicator("Resolved"),
                DisputeMgnt.class, arg2);

        Bundle arg3 = new Bundle();
        arg3.putString("Title", "NotCompleted");
        mTabHost.addTab(mTabHost.newTabSpec("Not Resolved").setIndicator("Not Resolved"),
                DisputeMgnt.class, arg3);
