...
import com.kotakcollection.Module.NCValidation;
import com.kotakcollection.R;


public class NCValidationTab extends Fragment {
    ...
    public static NCValidationTab newInstance(String param1, String param2) {
        NCValidationTab fragment = new NCValidationTab();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTabHost.addTab(mTabHost.newTabSpec("New").setIndicator("New"),
                NCValidation.class, arg1);

        Bundle arg2 = new Bundle();
        arg2.putString("Title", "Completed");
        mTabHost.addTab(mTabHost.newTabSpec("Available").setIndicator("Available"),
                NCValidation.class, arg2);

        Bundle arg3 = new Bundle();
        arg3.putString("Title", "NotCompleted");
        mTabHost.addTab(mTabHost.newTabSpec("Not Available").setIndicator("Not Available"),
                NCValidation.class, arg3);
