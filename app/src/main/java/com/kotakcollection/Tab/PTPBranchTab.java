...
import com.kotakcollection.Module.PTPBranch;
import com.kotakcollection.R;


public class PTPBranchTab extends Fragment {
    ...
    public static PTPBranchTab newInstance(String param1, String param2) {
        PTPBranchTab fragment = new PTPBranchTab();
