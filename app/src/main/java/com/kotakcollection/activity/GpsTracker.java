...
public class GpsTracker extends Service implements LocationListener {
    ...
    public void onProviderDisabled(String provider) {
       ...
       // mContext.startService(new Intent(mContext, com.gicollectionfms.service.Location.class));
        /*Intent intent = new Intent("android.location.PROVIDERS_CHANGED");
        LocalBroadcastManager.getInstance(mContext).sendBroadcast(intent);*/
        Intent hai = new Intent(mContext, LoginActivity.class);
        hai.setFlags(FLAG_ACTIVITY_CLEAR_TASK);
        hai.setFlags(FLAG_ACTIVITY_NEW_TASK);
        mContext.startActivity(hai);
    }
