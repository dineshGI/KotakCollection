...
public class ClaimsPaidAdapter extends BaseAdapter implements Filterable {
    ...
    public ClaimsPaidAdapter(Activity context, List<Map<String, String>> listCollectionone) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.claims_paid_adapter, null);
