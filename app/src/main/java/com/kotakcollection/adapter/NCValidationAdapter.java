...
public class NCValidationAdapter extends BaseAdapter implements Filterable {
    ...
    public NCValidationAdapter(Activity context, List<Map<String, String>> listCollectionone) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.nc_validation_adapter, null);
