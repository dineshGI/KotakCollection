...
public class PTPBranchAdapter extends BaseAdapter implements Filterable {
    ...
    public PTPBranchAdapter(Activity context, List<Map<String, String>> listCollectionone) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.ptp_branch_adapter, null);
