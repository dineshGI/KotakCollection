...
public class PTPOnlineAdapter extends BaseAdapter implements Filterable {
    ...
    public PTPOnlineAdapter(Activity context, List<Map<String, String>> listCollectionone) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.ptp_online_adapter, null);
